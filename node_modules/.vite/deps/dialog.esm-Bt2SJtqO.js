...
import { A as IconUtils, C as useUpdateEffect, E as ariaLabel, M as UniqueComponentId, N as ZIndexUtils, O as DomHandler, P as classNames, S as useUnmountEffect, T as PrimeReactContext, _ as useMountEffect, b as useStyle, c as Ripple, d as useHandleStyle, f as ESC_KEY_HANDLING_PRIORITIES, g as useMergeProps, h as useGlobalOnEscapeKey, j as ObjectUtils, l as IconBase, m as useEventListener, n as CSSTransition, p as useDisplayOrder, s as Portal, t as TimesIcon, u as ComponentBase, w as PrimeReact } from "./index.esm-Ig61o7n-.js";
...
var FocusTrap$1 = /* @__PURE__ */ import_react.memo(/* @__PURE__ */ import_react.forwardRef(function(inProps, ref) {
	...
	var getTarget = function getTarget$1() {
	...
	*/
	var setAutoFocus = function setAutoFocus$1(target) {
	...
	var getComputedSelector = function getComputedSelector$1(selector) {
		return ":not(.p-hidden-focusable):not([data-p-hidden-focusable=\"true\"])".concat(selector !== null && selector !== void 0 ? selector : "");
	};
	var onFirstHiddenElementFocus = function onFirstHiddenElementFocus$1(event) {
	...
	var onLastHiddenElementFocus = function onLastHiddenElementFocus$1(event) {
	...
	return function createHiddenFocusableElements() {
		...
		var createFocusableElement = function createFocusableElement$1(inRef, onFocus, section) {
...
var Dialog = /* @__PURE__ */ import_react.forwardRef(function(inProps, ref) {
	...
	var onDragStart = function onDragStart$1(event) {
	...
	var onDrag = function onDrag$1(event) {
		if (dragging.current) {
	...
	var onDragEnd = function onDragEnd$1(event) {
		if (dragging.current) {
	...
	var onResizeStart = function onResizeStart$1(event) {
		if (props.resizable) {
	...
	var convertToPx = function convertToPx$1(value, property, viewport) {
		!viewport && (viewport = DomHandler.getViewport());
		var val = parseInt(value);
		if (/^(\d+|(\.\d+))(\.\d+)?%$/.test(value)) return val * (viewport[property] / 100);
		return val;
	};
	var onResize = function onResize$1(event) {
		if (resizing.current) {
			var deltaX = event.pageX - lastPageX.current;
			var deltaY = event.pageY - lastPageY.current;
			var width = DomHandler.getOuterWidth(dialogRef.current);
	...
	var onResizeEnd = function onResizeEnd$1(event) {
		if (resizing.current) {
	...
	var resetPosition = function resetPosition$1() {
		dialogRef.current.style.position = "";
		dialogRef.current.style.left = "";
		dialogRef.current.style.top = "";
		dialogRef.current.style.margin = "";
	};
	var onEnter = function onEnter$1() {
		dialogRef.current.setAttribute(attributeSelector.current, "");
	};
	var onEntered = function onEntered$1() {
		props.onShow && props.onShow();
		if (props.focusOnShow) focus();
		enableDocumentSettings();
	};
	var onExiting = function onExiting$1() {
		if (props.modal) !isUnstyled() && DomHandler.addClass(maskRef.current, "p-component-overlay-leave");
	};
	var onExited = function onExited$1() {
		dragging.current = false;
	...
	var enableDocumentSettings = function enableDocumentSettings$1() {
		bindGlobalListeners();
	};
	var disableDocumentSettings = function disableDocumentSettings$1() {
		unbindGlobalListeners();
	};
	var updateScrollBlocker = function updateScrollBlocker$1() {
	...
	var updateGlobalDialogsRegistry = function updateGlobalDialogsRegistry$1(isMounted) {
	...
	var bindGlobalListeners = function bindGlobalListeners$1() {
		if (props.draggable) {
	...
	var unbindGlobalListeners = function unbindGlobalListeners$1() {
		unbindDocumentDragListener();
		unbindDocumentDragEndListener();
		unbindDocumentResizeListener();
		unbindDocumentResizEndListener();
	};
	var createStyle = function createStyle$1() {
	...
	var destroyStyle = function destroyStyle$1() {
	...
	var createCloseIcon = function createCloseIcon$1() {
	...
	var createMaximizeIcon = function createMaximizeIcon$1() {
		var icon;
	...
	var createHeader = function createHeader$1() {
		if (props.showHeader) {
	...
	var createContent = function createContent$1() {
	...
	var createResizer = function createResizer$1() {
	...
	var createTemplateElement = function createTemplateElement$1() {
		var _props$children;
...
//#endregion
export { Dialog as t };
//# sourceMappingURL=dialog.esm-Bt2SJtqO.js.map